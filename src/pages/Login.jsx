...
const ROLE_CARDS = [
  { role:'captain',         label:'Captain / Owner',               emoji:'⚓', sub:'Academy Owner Portal',                grad:'from-amber-500 to-orange-600'   },
  { role:'principal',       label:'Principal',                     emoji:'🏛️', sub:'Academy Leadership Portal',           grad:'from-violet-600 to-purple-800'   },
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input type="email" value={email} onChange={e => { setEmail(e.target.value); setErr('') }}
                        placeholder="your@email.com" className="input pl-10" autoFocus/>
                    </div>
                  </div>
